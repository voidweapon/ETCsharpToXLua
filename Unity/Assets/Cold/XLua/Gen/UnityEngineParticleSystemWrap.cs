...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineParticleSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlifetimeByEmitterSpeed", _g_get_lifetimeByEmitterSpeed);
        ...
        static int _m_SetPlaybackState(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetPlaybackState( 
                        _playbackState );
