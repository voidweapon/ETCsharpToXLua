...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUITextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.Text);
			Utils.BeginObjectRegister(type, L, translator, 0, 42, 24, 13);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcachedTextGenerator", _g_get_cachedTextGenerator);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcachedTextGeneratorForLayout", _g_get_cachedTextGeneratorForLayout);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmainTexture", _g_get_mainTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfont", _g_get_font);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettext", _g_get_text);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsupportRichText", _g_get_supportRichText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getresizeTextForBestFit", _g_get_resizeTextForBestFit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getresizeTextMinSize", _g_get_resizeTextMinSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getresizeTextMaxSize", _g_get_resizeTextMaxSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalignment", _g_get_alignment);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalignByGeometry", _g_get_alignByGeometry);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfontSize", _g_get_fontSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontalOverflow", _g_get_horizontalOverflow);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalOverflow", _g_get_verticalOverflow);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineSpacing", _g_get_lineSpacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfontStyle", _g_get_fontStyle);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelsPerUnit", _g_get_pixelsPerUnit);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsupportRichText", _s_set_supportRichText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setresizeTextForBestFit", _s_set_resizeTextForBestFit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setresizeTextMinSize", _s_set_resizeTextMinSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setresizeTextMaxSize", _s_set_resizeTextMaxSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setalignment", _s_set_alignment);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setalignByGeometry", _s_set_alignByGeometry);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfontSize", _s_set_fontSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontalOverflow", _s_set_horizontalOverflow);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalOverflow", _s_set_verticalOverflow);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineSpacing", _s_set_lineSpacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfontStyle", _s_set_fontStyle);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.TextAnchor _anchor;translator.Get(L, 1, out _anchor);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.UI.Text.GetTextAnchorPivot( 
                        _anchor );
