...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIInputFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.InputField);
			Utils.BeginObjectRegister(type, L, translator, 0, 80, 35, 24);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshouldHideMobileInput", _g_get_shouldHideMobileInput);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshouldActivateOnSelect", _g_get_shouldActivateOnSelect);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcaretBlinkRate", _g_get_caretBlinkRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcaretWidth", _g_get_caretWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextComponent", _g_get_textComponent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getplaceholder", _g_get_placeholder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcaretColor", _g_get_caretColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcustomCaretColor", _g_get_customCaretColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectionColor", _g_get_selectionColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonEndEdit", _g_get_onEndEdit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonValueChanged", _g_get_onValueChanged);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonValidateInput", _g_get_onValidateInput);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcharacterLimit", _g_get_characterLimit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontentType", _g_get_contentType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineType", _g_get_lineType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinputType", _g_get_inputType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettouchScreenKeyboard", _g_get_touchScreenKeyboard);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getkeyboardType", _g_get_keyboardType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcharacterValidation", _g_get_characterValidation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreadOnly", _g_get_readOnly);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmultiLine", _g_get_multiLine);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getasteriskChar", _g_get_asteriskChar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getwasCanceled", _g_get_wasCanceled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcaretPosition", _g_get_caretPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectionAnchorPosition", _g_get_selectionAnchorPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectionFocusPosition", _g_get_selectionFocusPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getminWidth", _g_get_minWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpreferredWidth", _g_get_preferredWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getflexibleWidth", _g_get_flexibleWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getminHeight", _g_get_minHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpreferredHeight", _g_get_preferredHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getflexibleHeight", _g_get_flexibleHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlayoutPriority", _g_get_layoutPriority);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshouldHideMobileInput", _s_set_shouldHideMobileInput);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshouldActivateOnSelect", _s_set_shouldActivateOnSelect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settext", _s_set_text);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcaretBlinkRate", _s_set_caretBlinkRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcaretWidth", _s_set_caretWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settextComponent", _s_set_textComponent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setplaceholder", _s_set_placeholder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcaretColor", _s_set_caretColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcustomCaretColor", _s_set_customCaretColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectionColor", _s_set_selectionColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setonEndEdit", _s_set_onEndEdit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setonValueChanged", _s_set_onValueChanged);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setonValidateInput", _s_set_onValidateInput);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcharacterLimit", _s_set_characterLimit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontentType", _s_set_contentType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineType", _s_set_lineType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinputType", _s_set_inputType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setkeyboardType", _s_set_keyboardType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcharacterValidation", _s_set_characterValidation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreadOnly", _s_set_readOnly);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setasteriskChar", _s_set_asteriskChar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcaretPosition", _s_set_caretPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectionAnchorPosition", _s_set_selectionAnchorPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectionFocusPosition", _s_set_selectionFocusPosition);
        ...
        static int _m_SetTextWithoutNotify(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetTextWithoutNotify( 
                        _input );
        ...
        static int _m_ProcessEvent(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ProcessEvent( 
                        _e );
